async function generateNota(orderId) {
  try {
    ...
    const notaTemplate = `
            <div class="nota" style="padding: 15px; font-family: Arial, sans-serif;">
                <div style="display: flex; align-items: center; justify-content: flex-start; margin-bottom: 15px; border-bottom: 2px solid #000; padding-bottom: 15px;">
                    <div style="width: 120px; margin-right: 15px;">
                        <img src="../resources/img/icons/jamadas.jpg" style="width: 100%; height: auto;" alt="Jamadas Logo">
                    </div>
                    
                    <div style="flex-grow: 1; text-align: center;">
                        <h2 style="margin: 0; font-size: 20px; color: #333; text-transform: uppercase; font-weight: bold;">NOTA PEMBELIAN</h2>
                        <h3 style="margin: 5px 0; font-size: 18px; color: #4CAF50;">Jamadas</h3>
                        <p style="margin: 5px 0; font-size: 12px; color: #666; line-height: 1.3;">
                ...
                <div style="margin-bottom: 15px; background-color: #f9f9f9; padding: 10px; border-radius: 5px;">
                    <table style="width: 100%; margin-bottom: 5px; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="width: 50%; padding: 5px; border-left: 2px solid #eee;">
                          ...
                          order.items && order.items.length > 0
                            ? order.items
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 8px; border: 1px solid #ddd; text-align: right; color: #666;">
                                        Rp ${formatNumber(item.harga_order)}
                                    </td>
                                    <td style="padding: 8px; border: 1px solid #ddd; text-align: center; color: #666;">
                                        ${item.jumlah_order}
                                    </td>
                                    <td style="padding: 8px; border: 1px solid #ddd; text-align: right; color: #333; font-weight: 500;">
                                        Rp ${formatNumber(
                            ...
                            `
                                ...
                                .join("")
                            : '<tr><td colspan="4" style="padding: 8px; border: 1px solid #ddd; text-align: center;">Tidak ada item</td></tr>'
                        }
                    </tbody>
                    <tfoot>
                ...
                <div style="position: relative; margin-top: 20px; padding: 15px; border-top: 2px solid #4CAF50;">
                    <div style="page-break-inside: avoid;">
                        <p style="text-align: center; margin: 5px 0; color: #666; font-size: 12px; font-weight: bold;">
                            Terima kasih telah berbelanja di Jamadas
                        </p>
                        <p style="text-align: center; margin: 5px 0; color: #888; font-size: 12px; font-style: italic;">
                            Simpan nota ini sebagai bukti pembelian yang sah
                        </p>
                        
                        <div style="text-align: center; margin-top: 10px; position: relative;">
                            <img src="../resources/img/icons/jamadas.jpg" 
                                style="width: 150px; opacity: 0.2; position: relative; z-index: 1;" 
                                alt="Watermark">
                        </div>
                    </div>
                </div>
